...
fun main (args: Array<String>)
{
	...
	CHECK("(or)", "NIL")
	ECHECK("ffoo", ErroId.Symbol.ordinal, "ffoo is not defined.")
	ECHECK("(", ErroId.Syntax.ordinal, "not found close parenthesis.")
	ECHECK(")", ErroId.Syntax.ordinal, "found excess close parenthesis.")
	ECHECK("(to-list 3)", ErroId.Type.ordinal, "cannot cast 3 to ConsT.")
	ECHECK("(to-vect 33)", ErroId.Type.ordinal, "cannot cast 33 to VectT.")
	ECHECK("(symbol 33)", ErroId.Type.ordinal, "cannot cast 33 to SymbT.")
	ECHECK("(to-queu 33)", ErroId.Type.ordinal, "cannot cast 33 to QueuT.")
	ECHECK("(setq ffoo 33)", ErroId.Symbol.ordinal, "ffoo is not defined.")
	ECHECK("\"", ErroId.Syntax.ordinal, "not found close double quote.")
	ECHECK("((lambda ((a . b)) a) 1)", ErroId.Syntax.ordinal, "cannot bind: ((a . b)) and (1)")
	ECHECK("(3 1)", ErroId.UnCallable.ordinal, "3 is not callable.")
	ECHECK("(+ 3 'a)", ErroId.Type.ordinal, "cannot add (3 a)")
	ECHECK("(- () 2)", ErroId.Type.ordinal, "cannot sub (NIL 2)")
	ECHECK("(* [] 2)", ErroId.Type.ordinal, "cannot mul ([] 2)")
	ECHECK("(/ 3 \"a\")", ErroId.Type.ordinal, "cannot div (3 \"a\")")
	ECHECK("(% 3 nil)", ErroId.Type.ordinal, "cannot mod (3 NIL)")
	ECHECK("(int 'sym)", ErroId.Type.ordinal, "cannot cast sym to InumT.")
	ECHECK("(float \"str\")", ErroId.Type.ordinal, "cannot cast \"str\" to FnumT.")
	CHECK("(empty ())", "T")
	CHECK("(empty [])", "T")
	CHECK("(empty (queu))", "T")
	CHECK("(empty \"\")", "T")
	...
	ECHECK("(getat 5 2)", ErroId.Type.ordinal, "cannot apply getat to 5")
	ECHECK("(setat (list 1 2 3) 2 44)", ErroId.Type.ordinal, "cannot apply setat to (1 2 3)")
	ECHECK("(setat \"ABC\" 1 '(1 . 2))", ErroId.Type.ordinal, "cannot setat (1 . 2) to \"ABC\"")
	...
	ECHECK("(load \"not/exist/path.ext\")"
			, ErroId.FileNotFound.ordinal, "not found file: \"not/exist/path.ext\"")
	ECHECK("(load 33)", ErroId.Type.ordinal, "cannot apply load to 33")
